...
#define TOKEN "BBFF-fGCQU2nMU8rzkT5zW7sMtzngzhIEcV" // Ubidots TOKEN name el mismo que usamos en clase
...
#define DEVICE_LABEL "yaelprueba4" // Nombre del dispositivo a crear
